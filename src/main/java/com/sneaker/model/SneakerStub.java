...
public class SneakerStub {
	...
	static {
		Sneaker a = new Sneaker(1L, "U869", "A very deep German UBoat", 44.12, 138.44, new Date(2020-02-14), "");
		sneakers.put(1L, a);
		
		Sneaker b = new Sneaker(2L, "Thistlegorm", "British merchant boat in the Red Sea", 44.12, 138.44, new Date(2020-02-14), "");
		sneakers.put(2L, b);
		
		Sneaker c = new Sneaker(3L, "S.S. Yongala", "A luxury passenger ship wrecked on the great barrier reef", 44.12, 138.44, new Date(2020-02-14), "");
		sneakers.put(3L, c);
	}
